...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="cpassword" placeholder="confirm admin password" required class="box">
      <!-- <select name="user_type" class="box">
         <option value="user">user</option>
         <option value="admin">admin</option>
      </select> -->
      <!-- <input type="text" name="user_type" class="box" placeholder="enter admin" > -->
